...
/* table to div */
        ...
        uiTable = $("<div id='table' class='small-3 block'>").attr("cellpadding", 5);
        uiTable2 = $("<div id='table2' class='small-9 block'>").attr("cellpadding", 5);
        //rendererControl = $("<td id='1'>");
        rendererControl = $("<div>");
        ...
        //colList = $("<td id='2'>").addClass('pvtAxisContainer pvtUnused');
        ...
        _fn = function(c) {
          ...
          valueList = $("<div data-reveal aria-labelledby='modalTitle' aria-hidden='true' role='dialog' id='myModal'>").addClass('pvtFilterBox').hide();
/* */
          valueList[0].addEventListener('keydown',function(e){
            if ( e.keyCode === 27 ) { // ESC
              valueList.toggle();
            }
          });
/* */
          ...
          if (keys.length > opts.menuLimit) {
            ...
            checkContainer = $("<div id='real2'>").addClass("pvtCheckContainer").appendTo(valueList);
        ...
        //tr1 = $("<tr id='r1'>").appendTo(uiTable);
        tr1 = $("<div id='r1'>").appendTo(uiTable);
        ...
        //$("<td id='r2'>").addClass('pvtVals').appendTo(tr1).append(aggregator).append($("<br>"));
        $("<div id='r2' style='visibility:hidden;''>").addClass('pvtVals').prependTo(uiTable).append(aggregator).append($("<br>"));
        //$("<td id='r3'>").addClass('pvtAxisContainer pvtHorizList pvtCols').appendTo(tr1);
        $("<div id='r3'>").addClass('pvtAxisContainer pvtHorizList pvtCols').appendTo(uiTable);
        //tr2 = $("<tr id='r4'>").appendTo(uiTable);
        tr2 = $("<div id='r4'>").appendTo(uiTable);
        //tr2.append($("<td id='r5'>").addClass('pvtAxisContainer pvtRows').attr("valign", "top"));

        //tr2.append($("<div id='r5'>").addClass('pvtAxisContainer pvtRows').attr("valign", "top"));
        $("<div id='r5'>").addClass('pvtAxisContainer pvtRows').attr("valign", "top").appendTo(uiTable);

        //pivotTable = $("<td id='r6'>").attr("valign", "top").addClass('pvtRendererArea').appendTo(tr2);
        pivotTable = $("<div id='r6'>").attr("valign", "top").addClass('pvtRendererArea').appendTo(uiTable2);
        if (opts.unusedAttrsVertical === true || unusedAttrsVerticalAutoOverride) {
          uiTable.find('tr:nth-child(1)').prepend(rendererControl);
          uiTable.find('tr:nth-child(2)').prepend(colList);
        } else {
          //uiTable.prepend($("<tr id='r7'>").append(rendererControl).append(colList));
          uiTable.prepend($("<div id='r7'>").append(rendererControl).append(colList));
        }
        // join divs
        uiTable3 = $("<div id='tableTop' class='grid-block'>");
        uiTable3.append(uiTable).append(uiTable2);
        //this.html(uiTable);
        this.html(uiTable3);
        //
        _ref3 = opts.cols;
